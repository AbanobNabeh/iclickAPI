...
<head>
    ...
    <style>
        ...
        * {
        ...
        .method-post {
            background: rgba(58, 181, 118, 0.16);
            color: #a4ffd4;
            border: 1px solid rgba(58, 181, 118, 0.24);
        }

        .method-get {
            background: rgba(81, 145, 255, 0.16);
            color: #bae0ff;
            border: 1px solid rgba(81, 145, 255, 0.24);
        }
...
<footer class="footer-container">
    <div class="footer-credit">Coded by <a href="https://abanobnabeh.github.io/portfolio/" target="_blank"
            rel="noopener"><strong>Abanob Nabeh</strong></a></div>
    <div class="footer-links">
        <a href="https://github.com/AbanobNabeh/iclickAPI.git" target="_blank" rel="noopener"
            class="github-button footer-button">
        ...
        <a href="https://github.com/AbanobNabeh/iClick" target="_blank" rel="noopener"
            class="github-button footer-button">
        ...
        <a href="https://instagram.com/AbanobNabeeh" target="_blank" rel="noopener" class="social-link"
        ...
        <a href="https://ko-fi.com/abanobnabeh" target="_blank" rel="noopener" class="social-link" aria-label="Ko-fi">
            <svg viewBox="0 0 24 24" aria-hidden="true">
                <path
                    d="M12 2.5C7.03 2.5 3 6.53 3 11.5c0 5.5 5.91 9.45 8.4 10.86a1.15 1.15 0 001.2 0C15.09 20.95 21 17 21 11.5 21 6.53 16.97 2.5 12 2.5zm0 15.5c-2.82-.18-6.4-2.58-6.4-6.5 0-3.5 2.85-6.3 6.4-6.5 3.55.2 6.4 3 6.4 6.5 0 3.92-3.58 6.32-6.4 6.5z" />
                <path
                    d="M10.5 8.75h1.1c.42 0 .76.34.76.76v5.02a.75.75 0 01-1.5 0V9.49h-.36a.74.74 0 01-.75-.74c0-.41.34-.74.75-.74zm3.76 2.04a.75.75 0 011.5 0v3.1a.75.75 0 01-1.5 0v-3.1z" />
            </svg>
        </a>
        <a href="https://www.linkedin.com/in/abanob-nabeh-181493224" target="_blank" rel="noopener" class="social-link"
            aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" aria-hidden="true">
                <path
                    d="M6.94 6.5a2.06 2.06 0 11-.001 4.122A2.06 2.06 0 016.94 6.5zm.06 4.98H4.5V20h2.5V11.48zm4.88 0h-2.5V20h2.5v-4.9c0-1.18.1-2.7 1.64-2.7 1.55 0 1.56 1.32 1.56 2.78V20h2.5v-5.2c0-3.7-.78-5.3-4.1-5.3-1.86 0-2.63 1.03-3.08 1.75h.04V11.5z" />
            </svg>
        </a>
        <a href="https://www.facebook.com/abanobnabeeh" target="_blank" rel="noopener" class="social-link"
            aria-label="Facebook">
            <svg viewBox="0 0 24 24" aria-hidden="true">
                <path
                    d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.43 8.86 8 9.8V15H8v-3h2v-2.2C10 8.8 11 8 12.76 8c.85 0 1.53.06 1.74.09v2.02h-1.2c-.94 0-1.12.45-1.12 1.1V12h2.3l-.3 3H13.3v6.8c4.57-.94 8-4.96 8-9.8z" />
            </svg>
        </a>
    </div>
</footer>
...
<body>
    <div class="page-shell">
        <aside class="sidebar">
            ...
            <p>Developer portal for IClick API. Browse docs, inspect JSON payloads, and test endpoints using a premium
                SaaS-style interface.</p>
            ...
            <ul class="endpoint-list">
                ...
                <li class="endpoint-link" data-endpoint="getreels">
                    <span class="endpoint-name">Get Reels</span>
                    <span>GET /api/getreels</span>
                </li>
                <li class="endpoint-link" data-endpoint="followuser">
                    <span class="endpoint-name">Follow User</span>
                    <span>POST /api/follow</span>
                </li>
                <li class="endpoint-link" data-endpoint="unfollowuser">
                    <span class="endpoint-name">Unfollow User</span>
                    <span>POST /api/unfollow</span>
                </li>
                <li class="endpoint-link" data-endpoint="uploadpost">
                    <span class="endpoint-name">Upload Post</span>
                    <span>POST /api/uploadpost</span>
                </li>
                <li class="endpoint-link" data-endpoint="uploadreel">
                    <span class="endpoint-name">Upload Reel</span>
                    <span>POST /api/uploadreel</span>
                </li>
                <li class="endpoint-link" data-endpoint="uploadstory">
                    <span class="endpoint-name">Upload Story</span>
                    <span>POST /api/uploadstory</span>
                </li>
                <li class="endpoint-link" data-endpoint="getstories">
                    <span class="endpoint-name">Get Stories</span>
                    <span>GET /api/getstories</span>
                </li>
            </ul>
        </aside>
        ...
        <main class="main-panel">
            <section class="hero-card">
                <div class="hero-top">
                    <div>
                        ...
                        <p class="subtitle">A modern developer portal for IClick API. View endpoints, inspect schema
                            samples, and execute live requests from a polished SaaS-style dashboard.</p>
                    </div>
            ...
            <section class="info-card section-grid">
                <article class="section-card">
                    <h3>Description</h3>
                    <p id="endpointDescription" class="note">Send OTP to user's email for authentication. Use this
                        endpoint to start the login flow with a one-time password.</p>
                </article>
                <article class="section-card">
                    <h3>How it works</h3>
                    <p class="note">Each endpoint includes schema previews, auth support, a live request panel, and a
                        developer console-style response viewer.</p>
                </article>
            </section>
  ...
  "status": true
            ...
            <section class="try-card">
                <div class="hero-top">
                    <div>
                        <h1>Try it</h1>
                        <p class="note">Execute a real request against the backend and preview the JSON response
                            instantly.</p>
                    </div>
                ...
                <div class="submit-row">
                    <p class="note">All requests use vanilla <code>fetch()</code>. For authenticated endpoints, paste
                        your bearer token in the field below.</p>
    ...
    <script>
        const endpoints = {
            ...
            getreels: {
                title: 'Get Reels',
                method: 'GET',
                url: 'https://iclickapi-main-vfl3rp.free.laravel.cloud/api/getreels',
                description: 'Fetch reels for the authenticated user using Bearer token authentication.',
                requestSample: null,
                responseSample: [{
                    id: 1,
                    user_id: 1,
            ...
            followuser: {
                title: 'Follow User',
                method: 'POST',
                url: 'https://iclickapi-main-vfl3rp.free.laravel.cloud/api/follow',
                description: 'Follow another user by sending their iduser in the request body. Requires Bearer token authentication.',
                requestSample: {
                    iduser: 2
                },
                responseSample: {
            ...
            unfollowuser: {
                title: 'Unfollow User',
                method: 'POST',
                url: 'https://iclickapi-main-vfl3rp.free.laravel.cloud/api/unfollow',
                description: 'Unfollow a user by sending their iduser in the request body. Requires Bearer token authentication.',
                requestSample: {
                    iduser: 2
                },
                responseSample: {
            ...
            uploadreel: {
                title: 'Upload Reel',
                method: 'POST',
                url: 'https://iclickapi-main-vfl3rp.free.laravel.cloud/api/uploadreel',
                description: 'Upload a reel using multipart/form-data with Bearer token authentication.',
                requestSample: {
                    file: 'mp4 video',
                    caption: 'string'
                },
            ...
            uploadstory: {
                title: 'Upload Story',
                method: 'POST',
                url: 'https://iclickapi-main-vfl3rp.free.laravel.cloud/api/uploadstory',
                description: 'Upload a story image using multipart/form-data with Bearer token authentication.',
                requestSample: {
                    file: 'image'
                },
                responseSample: {
            ...
            getstories: {
                title: 'Get Stories',
                method: 'GET',
                url: 'https://iclickapi-main-vfl3rp.free.laravel.cloud/api/getstories',
                description: 'Fetch stories for the authenticated user using Bearer token authentication.',
                requestSample: null,
                responseSample: [{
                    id: 1,
                    user_id: 1,
        ...
        const renderEndpoint = key => {
            ...
            requestSample.textContent = endpoint.requestSample ? formatJson(endpoint.requestSample) :
            ...
            liveResponse.textContent = formatJson({
                message: 'Choose an endpoint and send a request to see live JSON output.',
                status: null
            });
            setStatus('Ready');
            ...
            <div class="form-field" style="grid-column: 1 / -1;">
              ...
              <input id="${key}-${field.name}" name="${field.name}" type="file" accept="${accept}">
              <div id="preview-${field.name}" class="file-preview">
                <span>No file selected. Choose a file to preview.</span>
              </div>
            </div>
          `;
                }
        ...
        const attachFilePreview = () => {
            document.querySelectorAll('input[type="file"]').forEach(fileInput => {
                const preview = document.getElementById(`preview-${fileInput.name}`);
                if (!preview) return;

                fileInput.addEventListener('change', event => {
                    const file = event.target.files[0];
                    if (!file) {
                        preview.innerHTML = '<span>No file selected. Choose a file to preview.</span>';
                        return;
                    }
                    ...
                    if (file.type.startsWith('video/')) {
                        preview.innerHTML = `
              <span>Preview</span>
              <video controls src="${url}" style="width: 100%; max-height: 240px; border-radius: 18px;"></video>
            `;
                        return;
                    }
        ...
        const buildFetchOptions = payload => {
            ...
            if (endpoint.fields.some(field => field.type === 'file')) {
                const formData = new FormData();
                endpoint.fields.forEach(field => {
                    if (field.type === 'file' && payload[field.name]) {
                        formData.append(field.name, payload[field.name]);
                    }
                    if (field.type !== 'file' && field.name !== 'token' && payload[field.name] !== undefined) {
                        formData.append(field.name, payload[field.name]);
                    }
                });
                if (payload.token) options.headers.Authorization = `Bearer ${payload.token}`;
            ...
            if (endpoint.authHeader) {
                ...
                options.body = formatJson(bodyPayload);
                return options;
            }
